...
// // ─── Answer State ────────────────────────────
//
// enum AnswerState { unanswered, yes, no }
//
...
//   bool get allPassed =>
//       questions.every((q) => q.answer == AnswerState.yes) &&
//           answeredCount == totalCount;
//   bool get hasFailed => questions.any((q) => q.answer == AnswerState.no);
...
//   InspectionModel? _model;
//   List<SectionState> _sections = [];
//
//   bool get isLoading => _isLoading;
//   bool get hasError => _hasError;
//   String get errorMessage => _errorMessage;
//   InspectionModel? get model => _model;
...
//         _model = InspectionModel.fromJson(jsonBody);
//
...
//         }
//       } else {
//         _setError('HTTP ${response.statusCode}: ${response.body}');
//       }
//     } on TimeoutException {
//       _setError('Request timed out (30s). Check internet connection.');
//     } on SocketException catch (e) {
//       _setError('No internet connection: ${e.message}');
//     } on FormatException catch (e) {
//       _setError('JSON parse error: ${e.message}');
//     } catch (e, stack) {
//       debugPrint('→ ERROR: $e\n$stack');
...
//     if (q.answer != AnswerState.no) q.imagePath = null;
//     notifyListeners();
//   }
//
...
//   }
//
//   Map<String, dynamic> collectAnswers() {
...
//           answers.add({
//             'question_id': q.carData.questionId,
//             'question_text': q.carData.questionText,
//             'answer': q.answer.name,
//             'image_path': q.imagePath?.path,
//           });
//         }
//       }
//       result[section.label] = answers;
//     }
//     return result;
//   }
//
