...
class InspectionQueModel extends InspectionQueEntity{
  ...
  InspectionQueModel.fromJson(dynamic json) {
    ...
    _data = json['data'] != null ? InspectionQueData.fromJson(json['data']) : null;
  }
  bool? _status;
  String? _message;
  InspectionQueData? _data;
InspectionQueModel copyWith({  bool? status,
  ...
  InspectionQueData? get data => _data;
...
class InspectionQueData {
  ...
  InspectionQueData.fromJson(dynamic json) {
  ...
  InspectionQueData copyWith({  List<Inspection>? inspection,
  List<PostInspection>? postInspection,
  List<PreInspection>? preInspection,
}) => InspectionQueData(  inspection: inspection ?? _inspection,
