...
import 'package:ats_app/Data/repositories_impl/new_inspection_save_repo_impl.dart';
import 'package:ats_app/Data/repositories_impl/new_vehicle_list_repo_impl.dart';
...
import 'package:ats_app/Presentation/provider/new_inspection_save_provider.dart';
...
import '../../Domain/usecases/new_inspection_save_usecases.dart';
...
import 'new_vehicle_list_provider.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => NewVehicleListProvider(newVehicleListUseCases: NewVehicleListUseCases(newVehicleListRepository: NewVehicleListRepoImpl()))),
       ...
       // ChangeNotifierProvider(create: (_) => PreSaveInspectionProvider(useCase: PreSaveInspectionUseCase(repository: PreSaveInspectionImpl()))),
        ChangeNotifierProvider(create: (_) => NewInspectionSaveProvider(useCases: NewInspectionSaveUseCases(newInspectionSaveRepository: NewInspectionSaveRepoImpl()))),
